			...
			$admin = new AdminList(
				array(
					...
					"columns" => [
						...
						["title"=>"Сосотояние", "name"=>"user_status", "attrs"=>[ "data-breakpoints"=>"xs sm" ], "content"=>create_function('$cel,$row','switch($cel){	case 0: echo "<span class=\"red\">Отключен</span>"; break; case 1: echo "<span class=\"green\">Включен</span>"; break; }')],
					],
				)
			);
			$content = $admin;
		...
		$admin = new AdminPage(
			array(
				...
				"fields" => [
					...
					["title"=>"Имя", "name"=>"user_name", "attrs"=>[], "type"=>"editor"],
